 ...
 * Description: Calculates MPG and L/100KM
 */
package ch14;
...
//        rbMPG.setOnAction(e -> changeLabels());     
    ...
    private void changeLabels() {
    	double convertDistance = Double.parseDouble(tfDistance.getText());
    	double convertCapacity = Double.parseDouble(tfCapacity.getText());
    	double convertResult = Double.parseDouble(tfResult.getText());
    	...
    	if (combo.getValue().equals(altResult) && lblCapacity.getText().equals(defaultCapacity)) {
        	...
        	tfDistance.setText(String.format("%.2f", convertDistance * 1.60934));
        	tfCapacity.setText(String.format("%.2f", convertCapacity * 3.78541));
        	tfResult.setText(String.format("%.2f", convertResult * .588));
         } else {
        	// update labels
        	lblCapacity.setText(defaultCapacity);
        	lblDistance.setText(defaultMileage);
        	lblResult.setText(defaultResult);
        	tfDistance.setText(String.format("%.2f", convertDistance * 0.621371));
        	tfCapacity.setText(String.format("%.2f", convertCapacity * 0.264172));
        	tfResult.setText(String.format("%.2f", convertResult * 1.700680));
        }
    }
